...
public class BlockGuiInventory_GunCrafter extends GuiContainer
{
    ...
    private final TileEntity_GunCrafter tile;
    ...
    public BlockGuiInventory_GunCrafter(InventoryPlayer playerInv, IInventory furnaceInv, TileEntity_GunCrafter t)
    {
        super(new BlockContainerInventory_GunCrafter(playerInv, furnaceInv, t));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
    	 if (button.id == 0)
         {
    		 if(tile.id == 1) {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(11, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }else if(tile.id == 2) {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(12, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }else {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(1, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }
    	 ...
    	 if (button.id == 1)
         {
    		 if(tile.id == 1) {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(21, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }else if(tile.id == 2) {
    			 if(tile.sell_id > 0) {
        			 --tile.sell_id;
        		 }else {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(22, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }else {
    			 if(tile.sell_id > 0) {
        			 --tile.sell_id;
        		 }else {
        		 ...
        		 GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(2, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
    		 }
         }
            	 ...
            	 if(mod_GVCR2.gun_item_2[tile.sell_id] != null) {
                   	if(!eme.isEmpty() && eme.getItem() == Items.EMERALD
                   		...
                   		if(eme.getCount() >= mod_GVCR2.gun_eme_2[tile.sell_id]
                   			...
                   			tile.do_sell = true;
                   			GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(31, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
                   		}
                   	}
                   }
             }else if(tile.id == 2) {
            	 if(mod_GVCR2.gun_item_3[tile.sell_id] != null) {
                   	if(!eme.isEmpty() && eme.getItem() == Items.EMERALD
                   		...
                   		if(eme.getCount() >= mod_GVCR2.gun_eme_3[tile.sell_id]
                   			...
                   			tile.do_sell = true;
                   			GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(32, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
                   		}
                   	}
                   }
             }else {
            	 if(mod_GVCR2.gun_item_1[tile.sell_id] != null) {
                  	if(!eme.isEmpty() && eme.getItem() == Items.EMERALD
                  		...
                  		if(eme.getCount() >= mod_GVCR2.gun_eme_1[tile.sell_id]
                  			...
                  			tile.do_sell = true;
                   			GVCR2PacketHandler.INSTANCE.sendToServer(new GVCR2MessageKeyPressed(3, tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ()));
                  		}
                  	}
                  }
             }
    ...
    protected void drawGuiContainer_Item(float partialTicks, int mouseX, int mouseY)
    {
        ...
        
        {
        	...
        	{
				ItemStack item= new ItemStack(mod_GVCR2.gun_item_1[tile.sell_id]);
				if(tile.id == 1) {
					item = new ItemStack(mod_GVCR2.gun_item_2[tile.sell_id]);
				}else if(tile.id == 2) {
					item = new ItemStack(mod_GVCR2.gun_item_3[tile.sell_id]);
				}
				if (!item.isEmpty()) {
					int posx =   k + 56;
					int posy =   l + 17;
			...
			}
        	{
				...
				if (!item.isEmpty()) {
					...
					int kazu = mod_GVCR2.gun_eme_1[tile.sell_id];
					if(tile.id == 1) {
						kazu = mod_GVCR2.gun_eme_2[tile.sell_id];
					}else if(tile.id == 2) {
						kazu = mod_GVCR2.gun_eme_3[tile.sell_id];
					}
			...
			}
        	{
				...
				if (!item.isEmpty()) {
					...
					int kazu = mod_GVCR2.gun_iron_1[tile.sell_id];
					if(tile.id == 1) {
						kazu = mod_GVCR2.gun_iron_2[tile.sell_id];
					}else if(tile.id == 2) {
						kazu = mod_GVCR2.gun_iron_3[tile.sell_id];
					}
					String d2 = String.format("%1$3d", kazu);
			...
			}
        	{
				...
				if (!item.isEmpty()) {
					...
					int kazu = mod_GVCR2.gun_red_1[tile.sell_id];
					if(tile.id == 1) {
						kazu = mod_GVCR2.gun_red_2[tile.sell_id];
					}else if(tile.id == 2) {
						kazu = mod_GVCR2.gun_red_3[tile.sell_id];
					}
					String d2 = String.format("%1$3d", kazu);
