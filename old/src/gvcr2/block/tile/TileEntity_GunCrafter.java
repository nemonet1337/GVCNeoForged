...
public class TileEntity_GunCrafter extends TileEntityCrafterBase implements ITickable, ISidedInventory
{
    /**
    ...
    public void update()
    {
    	...
    	if(this.world.getBlockState(pos).getBlock() instanceof Block_GunCrafter) {
    		Block_GunCrafter gubcrafter = (Block_GunCrafter) this.world.getBlockState(pos).getBlock();
    	...
    	//System.out.println(String.format("%1$3d", mod_GVCR2.gun_id_1));
    	/*if(this.world.getBlockState(pos).getBlock() == mod_GVCR2.gvcr2_block_guncrafter_1){
    		id = 0;
    		ItemStack eme = (ItemStack)this.furnaceItemStacks.get(0);
            ItemStack iron = (ItemStack)this.furnaceItemStacks.get(1);
    ...
    {
        return new BlockContainerInventory_GunCrafter(playerInventory, this, this);
    }
}