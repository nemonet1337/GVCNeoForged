...
public class RenderGVCR2_GE_SE_HACS extends RenderLiving<EntityGVCR2_GE_SE_HACS> //extends RenderLiving<EntityDoll>
{
	private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/biped/hacs.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/biped/hacs.mqo"));
    
    public RenderGVCR2_GE_SE_HACS(RenderManager renderManagerIn)
    {
    ...
    public void rendermodel(EntityGVCR2_GE_SE_HACS entity, String model) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_GE_SE_HACS entity)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_GE_SE_HACS entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    private void renderlegs(EntityGVCR2_GE_SE_HACS entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	GL11.glPushMatrix();//glstart
    	{
    ...
    private void renderbody(EntityGVCR2_GE_SE_HACS entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	if(entity.deathTime > 0){
    ...
    protected void renderLivingAt(EntityGVCR2_GE_SE_HACS entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_GE_SE_HACS livingBase, float partialTicks)
    {
