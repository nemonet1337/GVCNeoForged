...
public class Render_GE_S_MR_CPT extends RenderLiving<EntityGVCR2_GE_S_MR_CPT> //extends RenderLiving<EntityDoll>
{
	private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/biped/guerrilla_mr_cpt.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/biped/guerrilla_mr_cpt.mqo"));
    
    public Render_GE_S_MR_CPT(RenderManager renderManagerIn)
    {
    ...
    public void rendermodel(EntityGVCR2_GE_S_MR_CPT entity, String model) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_GE_S_MR_CPT entity)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_GE_S_MR_CPT entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    private void renderlegs(EntityGVCR2_GE_S_MR_CPT entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	GL11.glPushMatrix();//glstart
    	{
    ...
    private void renderbody(EntityGVCR2_GE_S_MR_CPT entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	/*if(entity.deathTime > 0){
		...
		GL11.glPushMatrix();//glstart
		{
			...
			if(entity.getattacktask() && !(entity.deathTime > 0)) {
				if(entity.getClient_Gun_Count(entity) < 4){
	    			GL11.glRotatef(-entity.getClient_Gun_Count(entity), 1.0F, 0.0F, 0.0F);
	    		}
				...
				arm_r_rotex = Ax * (180F / (float)Math.PI) * 2;
			}
    ...
    protected void renderLivingAt(EntityGVCR2_GE_S_MR_CPT entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_GE_S_MR_CPT livingBase, float partialTicks)
    {
