...
public class Render_SO_S extends RenderBiped<EntityLiving>//これを入れると防具がバグる
{ 
	
	private  ResourceLocation tex = new ResourceLocation("gvcr2:textures/mob/soldier.png"); 
	private  ResourceLocation tex_mr = new ResourceLocation("gvcr2:textures/mob/soldier_mr.png"); 
	private  ResourceLocation tex_sn = new ResourceLocation("gvcr2:textures/mob/soldier_sn.png"); 

	private final float scale;
 
 	public Render_SO_S(RenderManager p_i46193_1_, float size) 
	{ 
