...
public class RenderGVCR2_AIR_YAK23KAI extends RenderLiving<EntityGVCR2_AIR_YAK23KAI>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/yak23kai.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/yak23kai.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_YAK23KAI(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_YAK23KAI entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			{
				RenderExhaust.can(entity, 0.0F, 1.25F, -1.0F, 1.0F, false, boatTextures);
			}
     ...
     private void renderAngle(EntityGVCR2_AIR_YAK23KAI p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_YAK23KAI entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_YAK23KAI entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_YAK23KAI livingBase, float partialTicks)
    {
