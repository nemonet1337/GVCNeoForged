...
public class RenderGVCR2_AIR_F16 extends RenderLiving<EntityGVCR2_AIR_F16>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/f16.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/f16.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_F16(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_F16 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			{
				RenderExhaust.can(entity, 0.0F, 2.0F, -7.8F, 1.0F, true, boatTextures);
			}
	...
	//			GlStateManager.depthFunc(517);//　ブロック透過+モブ非透過
	//			GL11.glClear(GL11.GL_COLOR_BUFFER_BIT | GL11.GL_DEPTH_BUFFER_BIT);
				tankk.renderPart("canopy");
				//GL11.glEnable(GL11.GL_DEPTH_TEST);
	//			GlStateManager.depthFunc(515);;//　ブロック透過+モブ非透過
				GL11.glColor4f(1F, 1F, 1F, 1F);
     ...
     private void renderAngle(EntityGVCR2_AIR_F16 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_F16 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_F16 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_F16 livingBase, float partialTicks)
    {
