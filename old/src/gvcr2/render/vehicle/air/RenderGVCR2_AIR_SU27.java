...
public class RenderGVCR2_AIR_SU27 extends RenderLiving<EntityGVCR2_AIR_SU27>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/su27.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/su27.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_SU27(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_SU27 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			{
				RenderExhaust.can(entity, 0.9F, 1.4F, -10.3F, 1.0F, true, boatTextures);
				RenderExhaust.can(entity, -0.9F, 1.4F, -10.3F, 1.0F, true, boatTextures);
			}
     ...
     private void renderAngle(EntityGVCR2_AIR_SU27 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_SU27 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_SU27 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_SU27 livingBase, float partialTicks)
    {
