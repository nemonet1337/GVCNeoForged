...
public class RenderGVCR2_AIR_YAK23 extends RenderLiving<EntityGVCR2_AIR_YAK23>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/yak23.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/yak23.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_YAK23(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_YAK23 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     private void renderAngle(EntityGVCR2_AIR_YAK23 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_YAK23 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_YAK23 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_YAK23 livingBase, float partialTicks)
    {
