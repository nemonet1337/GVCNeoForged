...
public class RenderGVCR2_AIR_A6 extends RenderLiving<EntityGVCR2_AIR_A6>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/a6.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/a6.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_A6(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_A6 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(!flag) {
			...
			{
				RenderExhaust.can(entity, 1.1F, 1.7F, -4.0F, 1.0F, false, boatTextures);
				RenderExhaust.can(entity, -1.1F, 1.7F, -4.0F, 1.0F, false, boatTextures);
			}
     ...
     private void renderAngle(EntityGVCR2_AIR_A6 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_A6 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_A6 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_A6 livingBase, float partialTicks)
    {
