...
public class RenderGVCR2_AIR_A4 extends RenderLiving<EntityGVCR2_AIR_A4>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/a4.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/a4.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_AIR_A4(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_AIR_A4 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			tankk.renderPart("we_m");
			{
				RenderExhaust.can(entity, 0.0F, 2.45F, -8.2F, 1.0F, false, boatTextures);
			}
     ...
     private void renderAngle(EntityGVCR2_AIR_A4 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_AIR_A4 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_AIR_A4 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_AIR_A4 livingBase, float partialTicks)
    {
