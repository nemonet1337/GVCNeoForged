...
public class RenderGVCR2_CAR_HMMWV extends RenderLiving<EntityGVCR2_CAR_HMMWV>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/car/hmmwv.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/car/hmmwv.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_CAR_HMMWV(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_CAR_HMMWV entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(entity.getArmID_L() == 1){
			GL11.glTranslatef(0F, 3.1F, -1.0F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_CAR_HMMWV entity)
    {
			return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_CAR_HMMWV entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_CAR_HMMWV livingBase, float partialTicks)
    {
