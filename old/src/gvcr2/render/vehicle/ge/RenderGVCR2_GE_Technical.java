package gvcr2.render.vehicle.ge;
...
public class RenderGVCR2_GE_Technical extends RenderLiving<EntityGVCR2_GE_Technical>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/technical.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/technical.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_GE_Technical(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_GE_Technical entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(entity.getArmID_L() == 1){
			...
			GL11.glTranslatef(0F, 3.1F, -0.6F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_GE_Technical entity)
    {
			return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_GE_Technical entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_GE_Technical livingBase, float partialTicks)
    {
