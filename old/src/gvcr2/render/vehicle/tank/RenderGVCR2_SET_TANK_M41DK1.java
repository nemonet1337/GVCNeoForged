...
public class RenderGVCR2_SET_TANK_M41DK1 extends RenderLiving<EntityGVCR2_TANK_M41DK1>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/m41dk1.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/m41dk1.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_M41DK1(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_M41DK1 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_M41DK1 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_M41DK1 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_M41DK1 livingBase, float partialTicks)
    {
