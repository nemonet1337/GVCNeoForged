...
public class RenderGVCR2_SET_TANK_T90 extends RenderLiving<EntityGVCR2_TANK_T90>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/t90.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/t90.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_T90(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_T90 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_T90 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_T90 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_T90 livingBase, float partialTicks)
    {
