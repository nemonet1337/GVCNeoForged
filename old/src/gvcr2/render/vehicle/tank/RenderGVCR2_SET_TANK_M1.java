...
public class RenderGVCR2_SET_TANK_M1 extends RenderLiving<EntityGVCR2_TANK_M1>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/m1_abrams.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/m1_abrams.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_M1(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_M1 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			
			{
				...
				GL11.glPushMatrix();
				GL11.glTranslatef(0F, 3.15F, 0.6F);
				GL11.glRotatef(entity.rotationp, 1.0F, 0.0F, 0.0F);
				GL11.glTranslatef(0F, -3.15F, -0.6F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_M1 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_M1 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_M1 livingBase, float partialTicks)
    {
