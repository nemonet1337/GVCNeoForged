...
public class RenderGVCR2_SET_TANK_M551 extends RenderLiving<EntityGVCR2_TANK_M551>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/m551.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/m551.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_M551(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_M551 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		}
		{
			...
			GL11.glTranslatef(0F, 1.95F, 1.1F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_M551 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_M551 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_M551 livingBase, float partialTicks)
    {
