...
public class RenderGVCR2_SET_TANK_KV2 extends RenderLiving<EntityGVCR2_TANK_KV2>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/kv2.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/kv2.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_KV2(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_KV2 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			GL11.glTranslatef(0F, 2.65F, 1.2F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_KV2 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_KV2 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_KV2 livingBase, float partialTicks)
    {
