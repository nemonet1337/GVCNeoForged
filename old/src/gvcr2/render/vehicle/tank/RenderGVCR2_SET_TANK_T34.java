...
public class RenderGVCR2_SET_TANK_T34 extends RenderLiving<EntityGVCR2_TANK_T34>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/t34_85.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/t34_85.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_T34(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_T34 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			GL11.glTranslatef(0F, 2.15F, 1.05F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_T34 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_T34 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_T34 livingBase, float partialTicks)
    {
