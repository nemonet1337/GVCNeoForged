...
public class RenderGVCR2_SET_TANK_SU_23_4 extends RenderLiving<EntityGVCR2_TANK_ZSU_23_4>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/zsu_23_4.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/zsu_23_4.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SET_TANK_SU_23_4(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_ZSU_23_4 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0F, 3.35F, -1.2F);
				GL11.glRotatef(entity.rotationp, 1.0F, 0.0F, 0.0F);
				GL11.glTranslatef(0F, -3.35F, 1.2F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_ZSU_23_4 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_ZSU_23_4 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_ZSU_23_4 livingBase, float partialTicks)
    {
