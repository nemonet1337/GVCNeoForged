...
public class RenderGVCR2_SET_TANK_RATTE extends RenderLiving<EntityGVCR2_TANK_RATTE>
{
    ...
    public RenderGVCR2_SET_TANK_RATTE(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_TANK_RATTE entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_TANK_RATTE entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_TANK_RATTE entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_TANK_RATTE livingBase, float partialTicks)
    {
