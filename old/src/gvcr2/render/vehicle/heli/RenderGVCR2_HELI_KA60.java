...
public class RenderGVCR2_HELI_KA60 extends RenderLiving<EntityGVCR2_HELI_KA60>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/ka60.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/ka60.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_KA60(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_KA60 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     private void renderAngle(EntityGVCR2_HELI_KA60 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_KA60 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_KA60 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_KA60 livingBase, float partialTicks)
    {
