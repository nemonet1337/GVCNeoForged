...
public class RenderGVCR2_HELI_AH1Z extends RenderLiving<EntityGVCR2_HELI_AH1Z>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/ah1z.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/ah1z.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_AH1Z(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_AH1Z entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(!flag) {
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0, 3.14F, -7.46F);
     ...
     private void renderAngle(EntityGVCR2_HELI_AH1Z p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_AH1Z entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_AH1Z entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_AH1Z livingBase, float partialTicks)
    {
