...
public class RenderGVCR2_HELI_UH1Y extends RenderLiving<EntityGVCR2_HELI_UH1Y>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/uh1y.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/uh1y.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_UH1Y(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_UH1Y entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0, 3.54F, -7.46F);
     ...
     private void renderAngle(EntityGVCR2_HELI_UH1Y p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_UH1Y entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_UH1Y entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_UH1Y livingBase, float partialTicks)
    {
