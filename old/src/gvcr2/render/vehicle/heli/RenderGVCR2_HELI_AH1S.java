...
public class RenderGVCR2_HELI_AH1S extends RenderLiving<EntityGVCR2_HELI_AH1S>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/ah1s.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/ah1s.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_AH1S(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_AH1S entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     private void renderAngle(EntityGVCR2_HELI_AH1S p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_AH1S entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_AH1S entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_AH1S livingBase, float partialTicks)
    {
