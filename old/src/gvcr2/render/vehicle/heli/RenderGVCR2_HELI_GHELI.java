...
public class RenderGVCR2_HELI_GHELI extends RenderLiving<EntityGVCR2_HELI_GHELI>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/g_heli.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/g_heli.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_GHELI(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_GHELI entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		GL11.glTranslatef(0, -1.6F, 0);
			...
			}
			{
				...
				GL11.glTranslatef(1.4F, 1.4F, -0.55F);
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0, 2.94F, -11.5F);
     ...
     private void renderAngle(EntityGVCR2_HELI_GHELI p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_GHELI entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_GHELI entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_GHELI livingBase, float partialTicks)
    {
