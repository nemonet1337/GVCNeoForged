...
public class RenderGVCR2_HELI_AH6 extends RenderLiving<EntityGVCR2_HELI_AH6>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/ah6.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/ah6.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_AH6(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_AH6 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     private void renderAngle(EntityGVCR2_HELI_AH6 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_AH6 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_AH6 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_AH6 livingBase, float partialTicks)
    {
