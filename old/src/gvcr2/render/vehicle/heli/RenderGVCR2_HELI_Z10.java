...
public class RenderGVCR2_HELI_Z10 extends RenderLiving<EntityGVCR2_HELI_Z10>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/heli/z10.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/heli/z10.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_HELI_Z10(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_HELI_Z10 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(!entity.onGround){
			GL11.glTranslatef(0, (float)(entity.riddingy[0] + 1.25F), 0.0F);//2.25F
		...
		if(!flag) {
			...
			
			{
				...
				}else if(entity.getArmID_R() == 1){
					tankk.renderPart("weapon_agm");
				}
				tankk.renderPart("weapon_m");
			}
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0, 3.84F, -7.06F);
     ...
     private void renderAngle(EntityGVCR2_HELI_Z10 p_76986_1_, int i){
		{
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_HELI_Z10 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_HELI_Z10 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_HELI_Z10 livingBase, float partialTicks)
    {
