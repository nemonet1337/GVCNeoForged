...
public class RenderGVCR2_SHIP_CRUISER extends RenderLiving<EntityGVCR2_SHIP_CRUISER>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/ship/cruiser.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/ship/cruiser.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_SHIP_CRUISER(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_SHIP_CRUISER entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			GL11.glTranslatef(1.4F, 1.9F, -2.6F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_SHIP_CRUISER entity)
    {
			return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_SHIP_CRUISER entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_SHIP_CRUISER livingBase, float partialTicks)
    {
