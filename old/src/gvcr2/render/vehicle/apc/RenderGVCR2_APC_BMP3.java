...
public class RenderGVCR2_APC_BMP3 extends RenderLiving<EntityGVCR2_APC_BMP3>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/apc/bmp3.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/apc/bmp3.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_APC_BMP3(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_APC_BMP3 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0F, 2.15F, 1.1F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_APC_BMP3 entity)
    {
			return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_APC_BMP3 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_APC_BMP3 livingBase, float partialTicks)
    {
