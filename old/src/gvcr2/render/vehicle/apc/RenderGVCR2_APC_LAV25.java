...
public class RenderGVCR2_APC_LAV25 extends RenderLiving<EntityGVCR2_APC_LAV25>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/apc/lav25.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/apc/lav25.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_APC_LAV25(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_APC_LAV25 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		if(entity.getArmID_L() == 1){
			...
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0F, 2.70F, -1.6F);
				GL11.glRotatef(entity.rotationp, 1.0F, 0.0F, 0.0F);
				GL11.glTranslatef(0F, -2.70F, 1.6F);
				tankk.renderPart("mat5_21");
				GL11.glPopMatrix();
			}
		}else {
			
			GL11.glTranslatef(0F, 2.0F, -0.9F);
			GL11.glRotatef(180.0F - entity.rotation-(180.0F - entityYaw), 0.0F, 1.0F, 0.0F);
			GL11.glTranslatef(0F, -2.0F, 0.9F);
			tankk.renderPart("mat4_1");
			{
				GL11.glPushMatrix();
				GL11.glTranslatef(0F, 2.6F, 0.1F);
				GL11.glRotatef(entity.rotationp, 1.0F, 0.0F, 0.0F);
				GL11.glTranslatef(0F, -2.6F, -0.1F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_APC_LAV25 entity)
    {
			return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_APC_LAV25 entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_APC_LAV25 livingBase, float partialTicks)
    {
