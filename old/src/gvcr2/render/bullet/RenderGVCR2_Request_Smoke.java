...
public class RenderGVCR2_Request_Smoke<T extends EntityGVCR2_Request_Smoke> extends Render<T>
{
    ...
    public RenderGVCR2_Request_Smoke(RenderManager renderManagerIn)
    {
