...
public class RenderGVCR2_BOSS_CHAR2C extends RenderLiving<EntityGVCR2_BOSS_CHAR2C>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/tank/char2c.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/tank/char2c.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_BOSS_CHAR2C(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_BOSS_CHAR2C entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		
		{
			...
			GL11.glTranslatef(0F, 3.6F, 4.2F);
		...
		
		{
			...
			GL11.glTranslatef(0F, 0F, -3.075F);
			GL11.glRotatef(180.0F - entity.rotationYawHead -(180.0F - entityYaw) - 180, 0.0F, 1.0F, 0.0F);
			GL11.glTranslatef(-0F, -0F, 3.075F);
			tankk.renderPart("mat4_2");
			GL11.glTranslatef(0F, 3.05F, -3.9F);
			GL11.glRotatef(entity.rotationp, 1.0F, 0.0F, 0.0F);
			GL11.glTranslatef(0F, -3.05F, 3.9F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_BOSS_CHAR2C entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_BOSS_CHAR2C entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_BOSS_CHAR2C livingBase, float partialTicks)
    {
