...
public class RenderGVCR2_BOSS_AIRSHIP extends RenderLiving<EntityGVCR2_BOSS_AIRSHIP>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/airship.png");
    private static final ResourceLocation g_tex = new ResourceLocation("gvcr2:textures/mob/guerrilla.png");
    ...
    public RenderGVCR2_BOSS_AIRSHIP(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_BOSS_AIRSHIP entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		{//右機銃
			...
			GL11.glPushMatrix();
			GL11.glTranslatef(-4F, 2F, -2.65F);
			GL11.glRotatef(180F - entity.rotation_1 -(180.0F - entityYaw), 0.0F, 1.0F, 0.0F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_BOSS_AIRSHIP entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_BOSS_AIRSHIP entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_BOSS_AIRSHIP livingBase, float partialTicks)
    {
