...
public class RenderGVCR2_BOSS_TB3 extends RenderLiving<EntityGVCR2_BOSS_TB3>
{
    private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/aircraft/tb3.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/aircraft/tb3.mqo"));
    /** instance of ModelBoat for rendering */

    public RenderGVCR2_BOSS_TB3(RenderManager renderManagerIn)
    {
     ...
     */
    float iii;
    public void doRender(EntityGVCR2_BOSS_TB3 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_BOSS_TB3 entity)
    {
    	{
			return boatTextures;
		}
    ...
    protected void renderLivingAt(EntityGVCR2_BOSS_TB3 entityLivingBaseIn, double x, double y, double z)
    {
    	GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_BOSS_TB3 livingBase, float partialTicks)
    {
