...
public class RenderGVCR2_BOSS_MER08_SN extends RenderLiving<EntityGVCR2_BOSS_MER08_SN>
{
	private static final ResourceLocation boatTextures = new ResourceLocation("gvcr2:textures/mob/model/robo/mer08_sn.png");
    private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/robo/mer08_sn.mqo"));
    
    private static final ResourceLocation merg01 = new ResourceLocation("gvcr2:textures/mob/model/robo/merg08rg.png");
    private static final IModelCustom merg01m = AdvancedModelLoader.loadModel(new ResourceLocation("gvcr2:textures/mob/model/robo/merg08rg.mqo"));
    ...
    public RenderGVCR2_BOSS_MER08_SN(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityGVCR2_BOSS_MER08_SN entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    private void renderlegs(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderleg_left(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderleg_right(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	float Ax = MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * limbSwingAmount;
    	GL11.glPushMatrix();//glstart
    	GL11.glTranslatef(- kneex, kneey, kneez);
    	GL11.glRotatef(-10, 0.0F, 0.0F, 1.0F);
    ...
    private void renderbody(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    	GL11.glTranslatef(bodyx, bodyy, bodyz);
    ...
    private void renderarm_left(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
		{
    ...
    private void renderarm_right(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderarm_rightgun(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
   
    }
    
    private void renderarm_leftgun(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
        
        }
    private void renderarm_subgun(EntityGVCR2_BOSS_MER08_SN entity, float limbSwing, float limbSwingAmount, float partialTicks){
    		
        }
    
    private void render_light(EntityGVCR2_BOSS_MER08_SN entity, String name){
    	GL11.glPushMatrix();//glstart
    	GL11.glDisable(GL11.GL_LIGHT1);
		GL11.glDisable(GL11.GL_LIGHTING);
    	int i = 15728880;
	...
	public float F6(EntityLivingBase entity, float partialTicks){
 	...
 	public void BoostRender(float bx, float by, float bz, String re, EntityGVCR2_BOSS_MER08_SN entity, float partialTicks){
 		boolean boost = false;
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGVCR2_BOSS_MER08_SN entity)
    {
    	return boatTextures;
    }
    
    protected void renderLivingAt(EntityGVCR2_BOSS_MER08_SN entityLivingBaseIn, double x, double y, double z)
    {
        GlStateManager.translate((float)x, (float)y, (float)z);
    }
    protected float handleRotationFloat(EntityGVCR2_BOSS_MER08_SN livingBase, float partialTicks)
    {
