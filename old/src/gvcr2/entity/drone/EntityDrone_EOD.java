...
public class EntityDrone_EOD extends EntityMAVBase
{
	
    public EntityDrone_EOD(World worldIn)
    {
        super(worldIn);
      ...
      //  this.spawn_item = mod_GirlFront.comand_drone;
        ...
        this.spawn_item = mod_GVCR2.gvcr2_drone_eod;
		...
		
		{
    		...
    		this.weapon1 = 1;
    		{
        		...
        		this.fire_time1[0] = 5;
        		this.sound_fire1[0] = "gvclib.fire_fire";
