...
public class EntityGVCR2_SET_MG_M2 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_MG_M2(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_m2;
		...
		
		{
    		...
    		this.weapon1key = 0;
    		this.w1name = "12.7mmMG";
    		this.ammo1 = 3;
    		this.magazine = 20;
    		this.reload_time1 = 55;
