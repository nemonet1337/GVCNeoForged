...
public class EntityGVCR2_SET_CANNON_Mk45 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_CANNON_Mk45(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_mk45_mod4;
