...
public class EntityGVCR2_SET_AA_20mmAA extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_AA_20mmAA(World worldIn)
    {
        super(worldIn);
        this.setSize(2.0F, 1.5F);
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_aa_20mmaa;
    ...
    public void onUpdate() {
		super.onUpdate();
		//this.roadattackPC(1);
		//VehicleCNT_Turret.load(this, null, true);
		this.typeTurret();
    }
