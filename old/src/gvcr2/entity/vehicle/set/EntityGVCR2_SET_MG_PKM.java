...
public class EntityGVCR2_SET_MG_PKM extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_MG_PKM(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_pkm;
