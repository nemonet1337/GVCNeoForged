...
public class EntityGVCR2_SET_CANNON_AK130 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_CANNON_AK130(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_ak130;
        
        this.sp = 0.0F;
        this.turnspeed = 1.5F;
        this.rotationp_max = -85F;
   ...
   //     this.rotation_max = 12F;
		...
		this.ridding_view1_y = -1.0F;
		this.ridding_view1_z = 1.3F;
		...
		
		{
    		...
    		this.weapon1key = 0;
    		this.w1name = "130mmCANNON";
    		this.ammo1 = 24;//12
    		this.magazine = 2;//6
    		this.reload_time1 = 100;//80
    		...
    		this.weapon1 = 1;
    		{
        		...
        		this.fire_pointy1[0] = 1.8F;
        		this.fire_pointz1[0] = 7.0F;
        		this.basis_pointx1[0] = 0;
        		this.basis_pointy1[0] = 1.8F;
