...
public class EntityGVCR2_SET_MG_M60 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_MG_M60(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_m60;
