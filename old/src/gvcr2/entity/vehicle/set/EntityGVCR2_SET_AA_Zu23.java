...
public class EntityGVCR2_SET_AA_Zu23 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_AA_Zu23(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_aa_zu23;
		...
		
		{
    		...
    		this.w1crossfire = true;
    		{
        		...
        		this.basis_pointx1[0] = 0.2F;
        		this.basis_pointy1[0] = 0.8F;
