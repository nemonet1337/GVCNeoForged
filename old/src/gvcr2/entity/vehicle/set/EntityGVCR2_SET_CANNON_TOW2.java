...
public class EntityGVCR2_SET_CANNON_TOW2 extends EntityMobVehicleBase
{
    public EntityGVCR2_SET_CANNON_TOW2(World worldIn)
    {
        super(worldIn);
        ...
        this.hud_icon_scope = "gvcr2:textures/misc/scope_tow.png";
        this.render_hud_scope_zoom = false;
        this.hud_icon_scope_zoom = "gvcr2:textures/misc/scope_tank_zoom.png";
        

        
        this.difficulty_adjustment = mod_GVCR2.cfg_damage_relief_vehicle;
        
        this.spawn_item = mod_GVCR2.gvcr2_spawn_set_mg_tow2;
