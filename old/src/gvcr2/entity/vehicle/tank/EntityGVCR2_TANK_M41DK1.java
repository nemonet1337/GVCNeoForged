...
public class EntityGVCR2_TANK_M41DK1 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_M41DK1(World worldIn)
    {
        super(worldIn);
        ...
        this.hud_icon_scope_zoom = "gvcr2:textures/misc/scope_tank_m60_nv.png";
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_m41dk1;
		...
		this.ridding_view1_z = 1.2F;
		
		this.can_turret = true;
		this.turret_height = 1.5F;
	    this.damage_front = 25;
	    this.damage_side = 25;
	    this.damage_rear = 20;
	    this.damage_top = 10;
	    this.damage_bottom = 10;
	    
	    this.damage_turret_front = 25;
	    this.damage_turret_side = 25;
	    this.damage_turret_rear = 25;
		...
		
		{
    		...
    		this.weapon1 = 1;
    		{
        		...
        		this.fire_pointy1[0] = 1.85F;
        		this.fire_pointz1[0] = 4.0F;
        		this.basis_pointx1[0] = 0;
        		this.basis_pointy1[0] = 1.85F;
        		this.basis_pointz1[0] = 1.3F;
		...
		
		{
    		...
    		this.weapon2 = 1;
    		{
        		...
        		this.fire_pointy2[0] = 1.85F;
        		this.fire_pointz2[0] = 1.6F;
