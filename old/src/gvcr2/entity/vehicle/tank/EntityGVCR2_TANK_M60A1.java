...
public class EntityGVCR2_TANK_M60A1 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_M60A1(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_m60a1;
