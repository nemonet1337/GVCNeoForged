...
public class EntityGVCR2_TANK_T34 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_T34(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_t34;
		...
		this.turret_height = 1.6F;
	    this.damage_front = 30;
	    this.damage_side = 30;
	    this.damage_rear = 20;
	    this.damage_top = 10;
	    this.damage_bottom = 10;
	    
	    this.damage_turret_front = 30;
		...
		
		{
    		...
    		this.weapon1 = 1;
    		{
    			...
    			this.fire_pointy1[0] = 2.1F;
    			this.fire_pointz1[0] = 4.0F;
    			this.basis_pointx1[0] = 0;
        		this.basis_pointy1[0] = 2.1F;
