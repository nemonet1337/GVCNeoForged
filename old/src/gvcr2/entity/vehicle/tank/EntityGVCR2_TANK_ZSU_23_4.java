...
public class EntityGVCR2_TANK_ZSU_23_4 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_ZSU_23_4(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_zsu_23_4;
		...
		
		{
    		...
    		for(int x = 0; x < 2; ++x){
        		...
        		this.fire_pointx1[0] = -0.2F;
        		this.fire_pointx1[1] = 0.2F;
        		this.fire_pointy1[0] = 2.35F;
        		this.fire_pointy1[1] = 2.2F;
        		this.fire_pointz1[x] = 2.5F;
        		this.basis_pointx1[x] = 0.0F;
        		this.basis_pointy1[x] = 2.1F;
