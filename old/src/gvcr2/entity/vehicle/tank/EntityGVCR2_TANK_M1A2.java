...
public class EntityGVCR2_TANK_M1A2 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_M1A2(World worldIn)
    {
        super(worldIn);
        ...
        this.night_vision = true;
        this.night_vision_tex = "gvclib:textures/misc/night_vision.png";
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_m1a2;
		...
		
		{
    		...
    		}
    		{
        		...
        		this.fire_time2[1] = 5;
        		this.sound_fire2[1] = "gvclib.fire_hmg";
        		this.fire_pointx2[1] = 0.0F;
        		this.fire_pointy2[1] = 3.15F;
        		this.fire_pointz2[1] = 1.6F;
        		this.basis_pointx2[1] = 0;
        		this.basis_pointy2[1] = 3.15F;
        		this.basis_pointz2[1] = 0.2F;
        		this.fire_yoffset2[1] = -0.03;
        		this.rotationfollowing2[1] = true;
        		this.rotationfirepoint2[1] = true;
        		this.bullet_damage2[1] = 8;
        		this.bullet_speed2[1] = 4F;
        		this.bullet_bure2[1] = 0.5F;
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(350D);
