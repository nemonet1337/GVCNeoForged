...
public class EntityGVCR2_TANK_PT76 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_PT76(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_pt76;
