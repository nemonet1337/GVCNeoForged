...
public class EntityGVCR2_TANK_T90 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_T90(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_t90;
