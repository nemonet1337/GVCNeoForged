...
public class EntityGVCR2_TANK_FV101 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_FV101(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_fv101;
		...
		riddingy[0] = 1.75;
		riddingz[0] = -0.8;
		riddingx_roteplayer[0] = -0.46;
		riddingy_roteplayer[0] = 0;
		riddingz_roteplayer[0] = -0.15;
		...
		
		{
    		...
    		this.weapon2 = 1;
    		{
        		...
        		this.basis_pointy2[0] = 2.0F;
        		this.basis_pointz2[0] = -0.8F;
