...
public class EntityGVCR2_TANK_KV2 extends EntityMobVehicleBase
{
    public EntityGVCR2_TANK_KV2(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_tank_kv2;
    ...
    protected void dropEquipment(boolean wasRecentlyHit, int lootingModifier)
    {
    	...
    	if(rand == 0) {
    		...
    		{
 				int ra = this.world.rand.nextInt(6) + 1;
 				for(int x = 0; x < ra; ++x) {
