...
public class EntityGVCR2_APC_BTR60 extends EntityMobVehicleBase
{

    public EntityGVCR2_APC_BTR60(World worldIn)
    {
        super(worldIn);
		...
		riddingx_roteplayer[0] = 0.0;
		riddingy_roteplayer[0] = 0.0;
		...
		//this.typeTank();
		this.spawn_item = mod_GVCR2.gvcr2_spawn_apc_btr60;
		this.typeTank();
		this.w1can_cooldown = true;
		this.w1name = "14.5mmHMG";
		this.ammo1 = 3;
		this.magazine = 10;
		reload_time1 = 55;
