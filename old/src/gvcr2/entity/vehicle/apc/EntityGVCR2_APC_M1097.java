...
public class EntityGVCR2_APC_M1097 extends EntityMobVehicleBase
{
    public EntityGVCR2_APC_M1097(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_apc_m1097;
		...
		*/
		...
		
		{
    		...
    		//this.w2crossfire = true;
    		{
        		...
        		this.bullet_model2[0] = "gvclib:textures/entity/BulletNormal.mqo";
		...
		this.w1crossfire = true;
		{
			...
			this.bullet_model1[0] = "gvclib:textures/entity/new/bullet_sam_small.mqo";
			this.bullet_tex1[0] = "gvclib:textures/entity/new/bullet_sam_small.png";
			...
			this.fire_pointx1[0] = 1.2F;
			this.fire_pointy1[0] = 3.25F;
			this.fire_pointz1[0] = 2.0F;
			this.basis_pointx1[0] = 0.0F;
    		this.basis_pointy1[0] = 3.35F;
    		this.basis_pointz1[0] = -1.8F;
			...
			this.bullet_livingtime1[0] = 800;
			this.missile_targeting_time_start1[0] = 5;
    		this.missile_targeting_time_end1[0] = 90;
		}
    }
