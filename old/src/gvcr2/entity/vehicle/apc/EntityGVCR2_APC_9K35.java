...
public class EntityGVCR2_APC_9K35 extends EntityMobVehicleBase
{
    public EntityGVCR2_APC_9K35(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_apc_9k35;
		...
		this.w1crossfire = true;
		{
			...
			this.bullet_model1[0] = "gvclib:textures/entity/new/bullet_aam_big.mqo";
			this.bullet_tex1[0] = "gvclib:textures/entity/new/bullet_aam_big.png";
			...
			this.missile_targeting_time_start1[0] = 10;
    		this.missile_targeting_time_end1[0] = 70;
		}
    }
