...
public class EntityGVCR2_APC_BMP3 extends EntityMobVehicleBase
{

    public EntityGVCR2_APC_BMP3(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_apc_bmp3;
		...
		this.typeTank();
		{
    		...
    		this.weapon1 = 1;
    		{
				...
				this.fire_pointz1[0] = 2.5F;
				this.basis_pointx1[0] = 0;
        		this.basis_pointy1[0] = 2.15F;
		...
		
		{
    		...
    		this.weapon2 = 1;
    		{
        		...
        		this.fire_time2[0] = 2;
        		this.sound_fire2[0] = "gvclib.fire_30mm";
        		this.fire_pointx2[0] = -0.2F;
				this.fire_pointy2[0] = 2.15F;
				this.fire_pointz2[0] = 1.7F;
				this.basis_pointx2[0] = 0;
        		this.basis_pointy2[0] = 2.15F;
        		this.basis_pointz2[0] = 1.0F;
   ...
   protected void dropEquipment(boolean wasRecentlyHit, int lootingModifier)
   {
   	...
   	if(rand == 0) {
   		...
   		if(ran == 0){
				int ra = this.world.rand.nextInt(16) + 10;
				for(int x = 0; x < ra; ++x) {
					this.entityDropItem(new ItemStack(Items.IRON_INGOT), 0.0F);
				}
			}else {
				int ra = this.world.rand.nextInt(16) + 8;
				for(int x = 0; x < ra; ++x) {
