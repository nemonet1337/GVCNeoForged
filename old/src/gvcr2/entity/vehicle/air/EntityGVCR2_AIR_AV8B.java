...
public class EntityGVCR2_AIR_AV8B extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_AV8B(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_av8b;
	...
	//	this.weapon2_auto_reload = false;
		...
		this.weapon2type = 1;
		{
    		...
    		this.w2crossfire = true;
        		...
        		this.fire_pointx2[0] = 4.9F;
        		this.fire_pointy2[0] = 1.9F;
    ...
    public void onUpdate() {
		...
		{
			VehicleCNT_AirCraft.load_vstol(this, GVCSoundEvent.sound_jet1, true);
		}
