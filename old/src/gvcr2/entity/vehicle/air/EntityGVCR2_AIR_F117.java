...
public class EntityGVCR2_AIR_F117 extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_F117(World worldIn)
    {
        super(worldIn);
...
//        this.render_hud_icon_bomber = true;
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_f117;
		...
		this.weapon1type = 3;
		{
    		...
    		this.weapon1 = 1;
    			...
    			this.bullet_model1[0] = "gvclib:textures/entity/new/bullet_bomb_big.mqo";
        		this.bullet_tex1[0] = "gvclib:textures/entity/new/bullet_bomb_big.png";
    ...
    public void onUpdate() {
		...
		/*{
			...
			this.spg_yaw -= MathHelper.sin(yaw) * xx;
			this.spg_picth += MathHelper.cos(yaw) * xx;
			this.spg_yaw -= MathHelper.sin(yaw - 1.57F) * zz;
			this.spg_picth += MathHelper.cos(yaw - 1.57F) * zz;
			...
			this.rotationp = -40;
			BlockPos bp = this.world.getHeight(new BlockPos(this.spg_yaw + this.posX, this.posY, this.spg_picth + this.posZ));
			this.spg_y = bp.getY();
		}*/
