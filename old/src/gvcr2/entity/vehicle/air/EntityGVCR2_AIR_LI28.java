...
public class EntityGVCR2_AIR_LI28 extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_LI28(World worldIn)
    {
        super(worldIn);
        this.setSize(10F, 3.4F);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_li28;
		...
		
		{
    		...
    		this.weapon1 = 1;
    		{
        		...
        		this.bullet_model1[0] = "gvclib:textures/entity/model/bomb.mqo";
        		this.bullet_tex1[0] = "gvclib:textures/entity/model/bomb.png";
