...
public class EntityGVCR2_AIR_A10 extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_A10(World worldIn)
    {
        super(worldIn);
  ...
  //      this.render_hud_icon_bomber = true;
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_a10;
    	...
    	if(this.getArmID_R() == 1) {
    		{
        		...
        		this.w2crossfire = true;
            		...
            		this.fire_pointx2[0] = 1.75F;
            		this.fire_pointy2[0] = 0.9F;
            		this.fire_pointz2[0] = 0.5F;
            		this.basis_pointx2[0] = 1.75F;
            		this.basis_pointy2[0] = 0.6F;
    		...
    		}
    		{
        		...
        		this.w3missile_aam = false;
        			this.bullet_type3[0] = 3;
            		this.bullet_model3[0] = "gvclib:textures/entity/model/bullet.mqo";
            		this.bullet_tex3[0] = "gvclib:textures/entity/model/bullet.png";
            		this.fire_model3[0]= "gvclib:textures/entity/mflash.mqo";
            		this.fire_tex3[0] = "gvclib:textures/entity/mflash.png";
            		this.fire_time3[0] = 5;
            		this.sound_fire3[0] = "gvclib.reload_clip";
            		...
            		this.bullet_speed3[0] = 1.6F;
            		this.bullet_bure3[0] = 10.0F;
            		this.bullet_expower3[0] = 2;
            		this.bullet_ex3[0] = mod_GVCR2.cfg_exprotion_player;
            		this.bullet_kazu3[0] = 20;
            		this.bullet_gravity3[0] = 0.00D;
            		this.bullet_livingtime3[0] = 200;
    		}
		}
