...
public class EntityGVCR2_AIR_YAK23KAI extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_YAK23KAI(World worldIn)
    {
        super(worldIn);
        this.setSize(8F, 4F);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_yak23kai;
