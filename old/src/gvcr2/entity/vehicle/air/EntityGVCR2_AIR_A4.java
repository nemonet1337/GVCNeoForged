...
public class EntityGVCR2_AIR_A4 extends EntityMobVehicleBase
{
    public EntityGVCR2_AIR_A4(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_air_a4;
		...
		vehicle_model_onground = false;
		/*vehicle_model_onground_x = 0.0D;
		vehicle_model_onground_y = 1.9D;
	...
	//	this.weapon2_auto_reload = false;
		...
		
		{
    		...
    		this.weapon1 = 2;
    		for(int x = 0; x < 2; ++x){
    			this.bullet_type1[x] = 1;
        		this.bullet_model1[x] = "gvclib:textures/entity/model/bullet_aaa.mqo";
        		this.bullet_tex1[x] = "gvclib:textures/entity/model/bullet_aaa.png";
        		this.fire_model1[x]= "gvclib:textures/entity/non.mqo";
        		this.fire_tex1[x] = "gvclib:textures/entity/non.png";
        		this.fire_time1[x] = 1;
        		this.sound_fire1[x] = "gvclib.fire_20mm";
        		this.fire_pointx1[0] = 0.6F;
        		this.fire_pointx1[1] = -0.6F;
        		this.fire_pointy1[x] = 1.6F;
        		this.fire_pointz1[x] = 0.0F;
        		this.basis_pointx1[x] = 0;
        		this.basis_pointy1[x] = (float) (riddingy[x] + 1.25F);
        		this.basis_pointz1[x] = 0.0F;
        		this.fire_yoffset1[x] = 0;
        		this.rotationfollowing1[x] = false;
        		this.rotationfirepoint1[x] = false;
        		this.rotation_player1[x] = false;
        		this.bullet_damage1[x] = 10;
        		this.bullet_speed1[x] = 8F;
        		this.bullet_bure1[x] = 1F;
        		this.bullet_expower1[x] = -1F;
        		this.bullet_ex1[x] = false;
        		this.bullet_kazu1[x] = 1;
        		this.bullet_gravity1[x] = 0.029D;
		...
		this.weapon2type = 1;
		{
    		...
    		this.w2crossfire = true;
        		...
        		this.fire_pointx2[0] = 2.4F;
        		this.fire_pointy2[0] = 1.1F;
