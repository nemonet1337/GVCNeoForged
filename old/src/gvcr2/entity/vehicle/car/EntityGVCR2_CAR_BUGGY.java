...
public class EntityGVCR2_CAR_BUGGY extends EntityMobVehicleBase
{

    public EntityGVCR2_CAR_BUGGY(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_car_buggy;
