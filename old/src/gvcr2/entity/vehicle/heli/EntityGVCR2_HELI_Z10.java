...
public class EntityGVCR2_HELI_Z10 extends EntityMobVehicleBase
{
    public EntityGVCR2_HELI_Z10(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_heli_z10;
		...
		
		{
    		...
    		this.weapon1 = 1;
    		{
        		...
        		this.fire_pointy2[0] = 0.45F;
        		this.fire_pointz2[0] = 0.0F;
        		this.basis_pointy2[0] = (float) (1.25F + riddingy[0]);
		...
		
		{
    		...
    		this.w3crossfire = true;
    		{
        		...
        		this.fire_pointx3[0] = 2.25F;
    			this.basis_pointx3[0] = 0.0F;
        		this.fire_pointy3[0] = 1.7F;
        		this.fire_pointz3[0] = -0.5F;
        		this.basis_pointy3[0] = (float) (1.25F + riddingy[0]);
    ...
    public void weapon_bay() {
    	if(this.getArmID_R() == 0){
    		...
    		this.w1missile_aam = false;
        		...
        		this.fire_pointx1[0] = 1.85F;
        		this.fire_pointy1[0] = 1.2F;
        		this.fire_pointz1[0] = -0.2F;
        		this.basis_pointx1[0] = 1.85F;
    ...
    public void onUpdate() {
		...
		{
			if(this.getControllingPassenger() instanceof EntityGVCR2_UNKS_C_S)
			{
				this.bullet_expower1[0] = 1.6F;
			}
		}
    }
