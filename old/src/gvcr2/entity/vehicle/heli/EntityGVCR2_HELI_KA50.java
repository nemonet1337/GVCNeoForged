...
public class EntityGVCR2_HELI_KA50 extends EntityMobVehicleBase
{
    public EntityGVCR2_HELI_KA50(World worldIn)
    {
        super(worldIn);
        ...
        this.spawn_item = mod_GVCR2.gvcr2_spawn_heli_ka50;
    ...
    public void weapon_bay() {
    	if(this.getArmID_R() == 0){
    		...
    		this.w1missile_aam = false;
        		...
        		this.fire_pointx1[0] = 2.7F;
        		this.fire_pointy1[0] = 0.95F;
        		this.fire_pointz1[0] = 0.5F;
        		this.basis_pointx1[0] = 2.7F;
        		this.basis_pointy1[0] = 0.95F;
