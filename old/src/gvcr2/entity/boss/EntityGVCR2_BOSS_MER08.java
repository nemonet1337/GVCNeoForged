...
public class EntityGVCR2_BOSS_MER08 extends EntityGVCR2_BOSSBase {
	
	public EntityGVCR2_BOSS_MER08(World worldIn) {
		super(worldIn);
			...
			if(AI_EntityWeapon.getRange(this, 40, 20, 20)){
				if(this.getAIType2() == 1 || this.getAIType2() == 2) {
		    		...
		    		String texf = "gvclib:textures/entity/model/mflash.png";
		        	{
		        		...
		        		if(this.counter1 && this.gun_count1 > 6){
		        			SoundEvent sounds = GVCSoundEvent.fire_hg;
		        			AI_EntityWeapon.Attacktask_new(this, this, 0, 40, 
				...
				if(entity.getHealth() > entity.getMaxHealth()/2) {
					...
					/*if(entity.aitypetime2 == 1) {
						...
						if(entity.getAIType2() == 1) {
							//entity.setPositionAndUpdate(entity.posX + ran, ey, entity.posZ + ran);
							entity.setPositionAndUpdate(entity.getMoveX()  + ran, entity.getMoveY(), entity.getMoveZ()  + ran);
						}
							...
							entity.setPositionAndUpdate(ex, ey, ez);
						}
						else {
						}
					}
