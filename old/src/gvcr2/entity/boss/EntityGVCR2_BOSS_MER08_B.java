...
public class EntityGVCR2_BOSS_MER08_B extends EntityGVCR2_BOSSBase {
	
	public EntityGVCR2_BOSS_MER08_B(World worldIn) {
		super(worldIn);
    	...
    	if(this.startuptime < 100) {
    		...
    		if(entity != null){
    			if(entity instanceof IMob){
    	        	...
    	        	par2 = par2 * AI_Damage.newAntiBullet(this, entity2, par2, 0.1F, 1.0F, 1.0F, 1.0F);
	...
	protected void onDeathUpdate() {
		...
		if(!this.world.isRemote && this.deathTime == 100) {
			GVCExplosionBase.ExplosionKai(this, this, this.posX + 0, this.posY + 0, this.posZ + 0, 2, false,  false);
			{
				...
				Chest3.setInventorySlotContents(13, new ItemStack(mod_GVCR2.gvcr2_gun_compoundbow, 1, 0));
				Chest3.setInventorySlotContents(3, new ItemStack(mod_GVCR2.gvcr2_am_exarrow, 1, 0));
				Chest3.setInventorySlotContents(5, new ItemStack(mod_GVCR2.gvcr2_am_psarrow, 1, 0));
		...
		if(this.getHealth() > this.getMaxHealth()/2)
		{
			if(this.getAIType() == 5)
			{
				...
				if(this.counter4 && cooltime4 > 20){
					String model = "gvclib:textures/entity/model/bullet_rocket.mqo";
		    		String tex = "gvclib:textures/entity/model/bullet_rocket.png";
		    		String modelf = "gvclib:textures/entity/model/mflash.mqo";
		    		String texf = "gvclib:textures/entity/model/mflash.png";
		    		SoundEvent sounds = GVCSoundEvent.fire_hg;
        			AI_EntityWeapon.Attacktask_new(this, this, 0, 10, 
        					model, tex, modelf, texf,2, sounds, 
        					-1.57F, 0.8, 1.5, 0.9, 0, 0, this.posX, this.posY, this.posZ,looked,this.rotationYawHead, 10, 10,
    						3, 2, 2, 0, false, 1, 0.029D, 80, 0);
					this.counter4 = false;
					this.setAIType(3);
					this.aitypetime = 0;
				...
				if(AI_EntityWeapon.getRange(this, 80, 40, 20)){
					{
			    		...
			    		String texf = "gvclib:textures/entity/model/non.png";
			        	{
			        		...
			        		if(this.counter1 && this.cooltime > 40){
			        			SoundEvent sounds = SoundEvents.ENTITY_ARROW_SHOOT;
			        			AI_EntityWeapon.Attacktask_new(this, this, 0, 80, 
			        					model, tex, modelf, texf,2, sounds, 
			        					1.57F, 0.8, 1.5, 0.9, 0, 0, this.posX, this.posY, this.posZ,looked,this.rotationYawHead, 10, 10,
			    						10, 3F, 1, 2F, false, 1, 0.02D, 80, 0);
